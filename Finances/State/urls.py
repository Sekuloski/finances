...
from .views import DeleteSubscription, Index, Payments, MakePayment, History, Subscribe, Change, AddFunds, MakeTestPayment, Subscriptions, TestPayments, UpdatePayment, UpdateSubscription, delete_view, addSalary
...
urlpatterns = [
    ...
    path('testPayments', TestPayments.as_view(), name="Test Payments"),
